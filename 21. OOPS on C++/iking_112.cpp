...
// MEMBER OF ONE CLASS CAN BE FRIEND FUNCTIONS OF ANTHER CLASS. 
// IN SUCH CASES THEY AE DEFINED USING THE SCOPE RESOLUTION OPERATOR 
class complex{
    int a;
    int b;
...
// SO THIS IS FAR BETTER METHOD THAN DOING THIS 
