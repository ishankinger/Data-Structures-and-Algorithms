...
// >> COMPILE TIME POLYMORPHISM ( KNOWS WHICH FUNCTION TO RUN AT COMPILE TIME ), 
//    ALSO KNOWN AS EARLY BINDING / STATIC BINDING / STATIC LINKING
...
// POINTERS TO OBJECT OF BASE CLASS ARE TYPE COMPATIBLE WITH POINTER TO OBJECTS OF DERIVED CLASS
// A SINGLE POINTER CAN BE MADE TO POINT TO OBJECTS BELONGING TO DIFFERENT CLASSES
...
int main(){
    ...
    // WE CAN ACCESS ONLY THOSE MEMBER WHICH ARE INHERITED FROM B AND NOT MEMBER ORIGINALLY FROM D
    ...
    // THIS WILL WORK AS TYPE CASTING THE POINTER
    cout << ((derivedClass*)base_class_ptr)->var_derived << "\n";
