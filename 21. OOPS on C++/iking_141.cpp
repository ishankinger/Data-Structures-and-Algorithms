...
int main(){
    ...
    // This is constructor-based implicit conversion. When you write time T3 = duration;,
    // the compiler sees an int being assigned to an object of class time, and automatically calls the constructor time(int).
    time T3 = duration; 
    T3.display();
