...
class Employee{                                      // A CLASS NAMED EMPLOYEE IS DEFINED
    ...
    // VARIABLE WITH ATTACH WITH CLASS SO THAT IT IS NOT PROPERTY OF A PARTICULAR OBJECT, IT IS 
    ...
    }                                                 // ACCESS TO STATIC VARIABLES AND OTHER STATIC FUNCTIONS
};
...
// VISIBLE ONLY WITHIN THE CLASS BUT LIFETIME IS ENTIRE PROGRAM
...
int main(){
    ...
    // getCount();                                     // CAN NOT CALL WITHOUT SCOPE RESOLUTION OPERATOR
