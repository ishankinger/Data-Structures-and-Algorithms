...
void deleteElePos(int pos){                      // FUNCTION TO DELETE ELEMENT AT GIVEN POS ( CONSIDERING 0 BASED INDEXING )
    Node* temp = head;
    while(pos-1){
        temp=temp->next;
        pos--;
...
int main(){
    LinkedList ll;                               // AN OBJECT OF LINKED LIST CLASS IS MADE AND DIFFERENT FUNCTIONS OF CLASS ARE USED ON IT
    ll.insertAtTail(1);
    ll.insertAtTail(2);
    ll.insertAtTail(3);
    ll.insertAtTail(4);
